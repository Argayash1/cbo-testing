    ...
    <section className={styles.root}>
      <div className={styles.container}>
        ...
        <div className={styles.dateContainer}>
          ...
          <CTA path='https://cbo.ru/' type='lead' linkText='Семинар-практикум' />
        </div>
        <h1 className={styles.title}>
          Жизнь и смерть вашего бизнеса: <span className={styles.titleSpan}>стабилизация</span>{' '}
          <span className={clsx(styles.titleSpan, styles.titleSpanTypeLast)}>в&nbsp;условиях санкций</span>
        </h1>
        <p className={styles.subtitle}>Куда вести компанию, когда горизонт планирования сужается?</p>
