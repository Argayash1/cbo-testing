...
export const AboutPractiсum = () => {
  ...
  const offset = screenWidth > 986 ? 421 : screenWidth <= 986 && screenWidth < 531 ? 235 : 178;

  return (
    <section>
      <div className={styles.container}>
        <SectionTitle titleText='Что говорят о&nbsp;практикуме?' place='about-practicum' />
        <CardSlider
        ...
        >
          {
            <ul className={styles.cardList} style={{ transform: `translateX(-${offset * switchCount}px)` }}>
              {cardListItems}
            </ul>
          }
        </CardSlider>
