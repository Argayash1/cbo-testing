...
export const SliderButton = ({ type, onClick, switchCount, nextButtonDisabled }: SliderNextButtonProps) => {
  return (
    <button
      className={clsx(styles.root, {
        [styles.rootTypeLeft]: nextButtonDisabled === undefined,
        [styles.rootTypeAboutPracticum]: type === 'about-practicum',
        [styles.rootTypeLeftAboutPracticum]: nextButtonDisabled !== undefined && type === 'about-practicum',
      })}
      onClick={onClick}
